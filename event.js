...
function picomix(){
  ...
  Because now you have an amazing challenge, an opportunity to bring out more out of mere digital photos.<br>𝗧𝗲𝗹𝗹 𝘂𝘀 𝗮 𝗹𝗶𝘁𝘁𝗹𝗲 𝘀𝘁𝗼𝗿𝘆 𝗯𝘆 𝗺𝗮𝗸𝗶𝗻𝗴 𝗮 𝗳𝗼𝘂𝗿 𝗽𝗮𝗻𝗲𝗹 𝗰𝗼𝗺𝗶𝗰 𝗼𝘂𝘁 𝗼𝗳 𝗽𝗶𝗰𝘁𝘂𝗿𝗲𝘀 𝘁𝗵𝗮𝘁 𝘆𝗼𝘂 𝗰𝗹𝗶𝗰𝗸𝗲𝗱.<br>Draw over the images using digital tools such as Photoshop, Illustrator, Sketchbook, Krita, Procreate, and even the instagram drawing tool if you like to torment yourself! Manage to impress the judges and you shall find a place rare amongst creators, a champion of photography, art and literature!
  `;

  event_details.innerHTML =`
  The event consists of two parts:<br>
A: Make a 4&minus;panel comic using pictures you clicked, by adding drawings/text on top with a digital drawing/editing software<br>
B: Transform 1 image that you’ve clicked by adding drawings/text on top with a digital drawing/editing software<br>
1. All the entries will be uploaded on social media by the Revival committee.<br>
2. Entries must be submitted using the google form which will be circulated<br>
3. This is a solo online event.<br>
  `;

  prizes.innerHTML=`
    Prizes in each category &minus; Winner awarded with ₹1000, runner up <br>
    awarded with ₹750 for<br>
    first event and ₹750 and ₹500 respectively for the second event .<br>
  `;
...
<br>1. Only digital submissions are accepted, i.e. the participant cannot take a printout of their
<br>picture and draw over it.
<br>2. Comic has to be 4 panels in length.
<br>3. One entry per event per person is allowed, i.e. a person can have two entries in total.
<br>4. Both events will be judged separately.
<br>5. You cannot overlay pre&minus;existing ClipArt over the images for the events, everything will
<br>have to be hand&minus;drawn. You can however edit text onto the image.
<br>6. The picture has to be clicked by the participant. You will have to provide EXIF
<br>information of the images used for verification. (details mentioned below)
<br>7. There is no particular theme for the comic/image, just go with the flow!
<br>8. There will be 3 judges for the event, and judging will be based on how unique the idea is,
<br>and how much it makes us feel/think.
<br>9. Name your entry in the format, Name_Institute
...
<br>participants who might not have access to most tools
<br>● PicsArt
<br>● Autodesk Sketchbook
<br>● Instagram
<br>● Google Storyboard (for comics)
<br>● Adobe Inkscape (laptop only)
<br>EXIF information :
<br>1. Share EXIF info for each of the images used.
...
<br>3. Share the original image you used to create the entry.
  ...
  timeline.innerHTML =`
  <br>  1. 6th March &minus; Registration google form opens for entries.
  <br>  2. 27th March &minus; Registration google form closes.
  <br>  3. 3rd April &minus; Announcement of results
  `;
  ...
  contact.innerHTML=`
  Contact us &minus;
<br> Sagnik C &minus; +91 9748216919
<br> Gowri N  &minus; +91 8086030097
<br> @pixels_iiserpune
<br> @artclub_iiserp
  `;
...
function articulate(){
  ...
  about.innerHTML=`
  A refreshing take on artistry, ARTiculate asks you to express yourself with both paints and prose. Let's see who can concoct the best piece of creative craftsmanship!<br>

𝗣𝗮𝗿𝘁𝗶𝗰𝗶𝗽𝗮𝗻𝘁𝘀 𝘄𝗶𝗹𝗹 𝗻𝗲𝗲𝗱 𝘁𝗼 𝗽𝗲𝗻 𝗱𝗼𝘄𝗻 𝗮 𝘀𝘁𝗼𝗿𝘆 𝗿𝗲𝘃𝗼𝗹𝘃𝗶𝗻𝗴 𝗮𝗿𝗼𝘂𝗻𝗱 𝗮 𝗴𝗶𝘃𝗲𝗻 𝗮𝗯𝘀𝘁𝗿𝗮𝗰𝘁, 𝗳𝗼𝗹𝗹𝗼𝘄𝗲𝗱 𝗯𝘆 𝗺𝗮𝗸𝗶𝗻𝗴 𝗮𝗻 𝗮𝘄𝗲𝘀𝗼𝗺𝗲 𝗰𝗼𝘃𝗲𝗿 𝗮𝗿𝘁 𝗳𝗼𝗿 𝘁𝗵𝗲 𝘀𝗮𝗺𝗲.<br>
...
The submission with the best combined score for the short story and the cover art will be crowned as the most ARTiculate work!
  ...
  elegibility.innerHTML=`
  The participating group should be a currently enrolled student of any of the participating institutes (All IISERs, NISER, IISc, CEBS). Alumnus not allowed to participate.<br>
This is a group event and will operate on the basis of submissions.<br>
Every member of a team should be from the same institution.<br>
  ...
  The contestants will write a 500 - 750 words story based on the given abstract/prompt and then make a befitting cover art for their story. They also need to write a brief description (50-100 words) about how the cover art relates to the story.<br>
The cover art should not be made/edited digitally. It should be drawn/sketched/painted by you on paper.<br>
...
only those teams who had registered would be considered for judging.<br>
All further communications with the participants will be done through the mail/contact provided in the registration form.<br>
Any entries which are found to be plagiarised will be instantly disqualified.<br>
The result of the event will be delivered by the 4th of April.<br>
...
<br>  April 4nd: Result Declaration.
  ...
  sub_details.innerHTML=`
  The cover art and the brief description should be in one pdf file and the story in another.<br>
  The teams are expected to upload their pdf files (both story and [cover-art+description]) in a single drive folder and provide the link to the folder in the submission form.<br>
  Do not mention the name of the participants anywhere in any of the documents.<br>
  The file name should be of the format “Articulate_teamname_(story/cover)”<br>
  The submission link for the event will be available on 14th March and it will be active till 27th March.<br>

  `;

  contact.innerHTML=`
  Arnab Lahiry (8697949062) @spy.d_42 (arnab@students.iisertirupati.ac.in) <br>
  Chaitanya Chawak (9405907765) (chaitanyachawak@students.iisertirupati.ac.in)<br>
  Sushmita Halder (8929798359) (sushmitahalder@students.iisertirupati.ac.in) <br>
  `;
...
function manthan(){
  ...
  about.innerHTML=`
    NISER presents Manthan, a drama event that, not unlike its name, will amalgamate seemingly unrelated characters from the world of literature and cinema. A refreshing change from the usual drama events, we invite acts where the personalities of these random characters must be preserved. Thereby, the end result should be a unique production of a fun and coherent plot.<br>

    So come on, bring your ‘A’ game to us! Put on your thinking caps, and wait for us to unleash the characters on you!.

    `;

  event_details.innerHTML =`This is a group event and will operate on basis of video submissions.<br>
    Each group would be given 4 random characters and they need to evolve a plot to present all four characters in a single play.<br>
    A team can choose extra two characters of their choice to assist their plot. So a maximum of 6 students can participate.<br>


  `;

  prizes.innerHTML=`1st Prize: 3000 INR <br>
Runner’s Up: 1500 INR

  `;

  judging_criteria.innerHTML=`Facial expressions, body language, dialogue delivery by actors and theme, plot development, character utilisation of the script will be prime considerations for judgement. <br>
 There will be negative marking if the upper cap of the video limit is exceeded. <br>
 Finer video editing would gain extra points.
  ...
  guidelines.innerHTML=`
All participants are required to fill the form within the deadline and all further communications will be done through the mail/contact provided in the form. <br>
Further instructions, mode of submission and character assignments will be sent out to the participants on 14th march 2021. <br>
 The video should be maximum of 15 mins in landscape mode. The videos can be shot individually (keeping in mind that people may be at home, not on campus) with one person per frame which should be then compiled into a single video play. <br>
The play can be in any language but English subtitles are mandatory. <br>
The script should be uploaded with a video file in English language only. <br>
Please avoid abusive or derogatory speech.
  ...
  timeline.innerHTML =`
The registration opens on 7th march 2021. <br>
The registration form will be circulated and should be filled latest by 13th March 2021, 11:59pm. <br>
Deadline for submission of the video of the play will be 24th March 2021, 11:59pm. <br>
...
Subham Mishra- 9178505655,<br>  subham.mishra@niser.ac.in @_mr.mishra_ <br>
Nikhil Kumar- 9470431483,<br>  nikhilkumar18@niser.ac.in @el_professor_ <br>
Tanya Pattnaik- 8118031373,<br> tanya.pattnaik@niser.ac.in @her_nerdiness
...
Theme Selection, Use of materials, originality, presentation, Grooming, Confidence, Attention details with accessories and costume, Overall Impact
  ...
  elegibility.innerHTML=`
This is a Team event. Only students of IISERs, NISER, CEBS and IISc can form teams (within respective institutes) and are allowed to participate. <br>
Team 4~10

 `;

  guidelines.innerHTML=`
Make apparel (clothing or outfit worn in a function) out of the materials which are normally thrown out as waste. <br>
Every Team must have a theme. The theme can be decided by the team itself. <br>
...
Backing track/music is allowed in the video file. <br>
Make a list of all the waste materials used in a .pdf format. <br>
Only 1 entry is allowed per participant <br>
Note that the video should not be edited in any way. Use of any kind of special effects is STRICTLY prohibited and will lead to direct disqualification <br>
Newspapers, magazines, paper bags, fabric strips, jute bags, gift wraps, etc are some examples of the waste materials which can be used <br>
Only the shape/size of the waste materials is allowed to change. Modifying any other physical attribute is not allowed (Example - Painting newspapers is not allowed. You are only allowed to change the shape/size of a newspaper). <br>
Only waste materials are to be used. You can’t use newly bought fresh materials <br>
Ready-made costumes are not allowed, but there is no restriction on improvising. <br>
No form of obscenity will be encouraged and it can lead to immediate disqualification. <br>
...
function lazarus(){
  ...
  event_details.innerHTML =`
  This is a ​solo online event.<br>
  It has two categories,​ vocal and instrumental​.<br>
  The event will be conducted in 3 rounds.<br>
  `;

  prizes.innerHTML=`
  Winner in each category :₹1000​,<br>
  Runner up in each category: ​₹500 <br>
  A ​special mention(s)<br>
  `;

  judging_criteria.innerHTML=`
  Entries will be also judged based on the vocals, presentation, pitching quality, pronunciation and theme correspondence.<br>
  ...
  guidelines.innerHTML=`
  Participants should follow the timeline properly. Registration through the google form is a must. The submission-google forms will be sent to registered participants.<br>
  A participant can either participate in the vocal OR instrumental category.<br>
  The video entry should be a ​maximum of 7 minutes​ in length.<br>
  There are no genre restrictions.<br>
  ...
  timeline.innerHTML =`
  5th March​ -  Registration opens, google form on this page.<br>
  6th March -  <ul>
  ...
  8th March​ - Submission for 1st round closes. <br>
  ...
  16th March​ - Submission google form of 2nd Round closes. (Subject to change according to technicalities.)<br>
  1st April - <ul>
    <li>​ Announcement of 2nd round results​.</li>
    <li>3rd thematic image released.</li>
    <li>Final round submission opens.</li>
  </ul><br>
  3rd April​ - Submission google form of final round closes.<br>
  10th April -​Announcement of winners in the vocal and instrumental category.<br>
  `;
  ...
  contact.innerHTML=`
  Aayush Srivastav - 6266748990 @musicclubofiiserk<br>
  Soumi Bhattacharyya - 6291141950 @soumi_hiya<br>
  Sroyon Sengupta -  9748960044 @auditore_de_ssg<br>
  Shubhamay - 8918115319 @shubhmay8380<br>
  music.activity@iiserkol.ac.in<br>
  `;
...
function cicada(){
  ...
  about.innerHTML=`Sick of solving your course and life problems? Enjoy the high of solving puzzles? <br>
Take a break and join us in the battle of wits against time in our very own CICADA 3301, an online puzzle game organised by IISER Bhopal. This is no simple feat for a lone wolf so don't forget to bring your buddies with you, making a team of maximum 3-4 members to sail you through the quest. <br>
...
Team size Maximum limit 4
  ...
  contact.innerHTML=`Sarthak - +91 7077965840  <br>   @sathak.g_art <br>
Harshwardhan <br> +91 6263163831 <br>
...
Judgement will be done by professionals in the field. <br>
Judgement will be done on the basis of originality, creativity, music sense, difficulty level of the performance and costume creativity.
  ...
  guidelines.innerHTML=`There is no restriction on the dance style, theme, music and costume, it can be chosen according to the participants own freedom. <br>
Only one entry per person will be accepted. <br>
Record your video in a still frame, camera shouldn’t be moving. <br>
The video should not be edited and completed in a single shot. <br>
The video should not be longer than 2 minutes.
  ...
  timeline.innerHTML =`
Timeline: <br>
March 8th: Google form Registrations open. <br>
March 25th: Google form registrations close <br>
April 2nd: Result Declaration.
  `;

  sub_details.innerHTML=`
  To participate in the competition, contestants must register via google form. Link to which is attached with the mail. The guidelines for filling the google forms are given below. <br>

  Use your institute e-mail IDs only to fill this form. Entries from Multiple or non-institution email IDs will not be accepted. <br>
The video file should not be more than 500 mb in size. <br>
The video should be in MP4 format specifically. <br>
...
Contact information:
Naman Mishra {naman.mishra@cbs.ac.in} <br>
...
An online photography competition without any thematic restrictions is the perfect platform to express yourself with your pictures, woven together to tell your story. While life may have come to a standstill this year, we still have memories encased in our camera reels. So get ready to share your best clicks in this enthralling competition!
  ...
  event_details.innerHTML =`
This is a solo event, each participant can send only 1 photo. <br>
The link for submissions will be put on the Revival website & Lumière Instagram page (@lumiere.iiserm) . <br>
...
Winners will be declared on the basis of highest points (calculated after 24 hours respectively). -->
  ...
  elegibility.innerHTML=`
The participating individual should be a currently enrolled student of the participating institutes. <br>
This is a solo event and will operate on basis of submissions. <br>
...
This is a solo event, each participant can send only 1 photo. <br>
Photo should be in JPG/JPEG format. <br>
The participant is expected to send us the photo between 14/03/2021 & 27/03/2021. <br>
Only entries from Google form will be considered. <br>
You are supposed to provide us a Google drive link to your photo from where we can download it. <br>
Due to Google’s policies, you will need to provide access when requested. (Just sharing the link is not enough.) <br>
...
The judgement of the event will be delivered by 30/03/2021 on @lumiere.iiserm (instagram).
  ...
  sub_details.innerHTML=`We shall provide the necessary link for submission for the event by 13/03/2021. <br>
The registration opens on 14/03/2021, kindly fill the form by 27/03/2021. All participants are required to fill the form within the deadline and all further communications will be done through the mail/contact provided in the form.<br>
`;

  contact.innerHTML=`Contact us :- Shounak Hinge, convener, Lumière <br>
9145496175 <br>
29shounak.hinge@gmail.com <br>
@shounak_hinge
...
Tony Nixon Mavely - 8281517015 <br>
 tonynixonmavely17@iisertvm.ac.in <br>
